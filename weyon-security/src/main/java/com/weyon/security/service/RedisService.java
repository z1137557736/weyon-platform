...
public class RedisService {
     ...
     */
    public boolean hasKeyHashItem(String key, String item) {
     ...
     * @return
     */
    public double incrementHashItem(String key, String item, double by) {
     ...
     * @return
     */
    public double decrementHashItem(String key, String item, double by) {
        return redisTemplate.opsForHash().increment(key, item, -by);
    }
     ...
     * @return true 存在 false不存在
     */
    public boolean hasKeySetItem(String key, Object value) {
        try {
     ...
     * @return
     */
    public boolean setFirstList(String key, Object value) {
        try {
     ...
     * @return
     */
    public boolean setFirstList(String key, Object value, long time) {
        try {
            redisTemplate.opsForList().leftPush(key, value);
            if (time > 0){
                expire(key, time);
     ...
     * @return
     */
    public boolean setLastList(String key, Object value) {
        try {
     ...
     * @return
     */
    public boolean setLastList(String key, Object value, long time) {
        try {
            redisTemplate.opsForList().rightPush(key, value);
            if (time > 0){
                expire(key, time);
