...
public class ObjectResponse implements Serializable {
    ...
    public static ObjectResponse ok() {
        return new ObjectResponse(HttpStatus.OK.value(), SUCCESS_TIP);
    }

    public static ObjectResponse ok(String msg) {
        return new ObjectResponse(HttpStatus.OK.value(), msg);
    }

    public static ObjectResponse ok(Object data) {
        return new ObjectResponse(HttpStatus.OK.value(), SUCCESS_TIP, data);
    }

    public static ObjectResponse ok(Object data, String msg) {
        return new ObjectResponse(HttpStatus.OK.value(), msg, data);
    }

    public static ObjectResponse fail() {
        return new ObjectResponse(HttpStatus.INTERNAL_SERVER_ERROR.value(), FAIL_TIP);
    }

    public static ObjectResponse fail(String msg) {
        return new ObjectResponse(HttpStatus.INTERNAL_SERVER_ERROR.value(), msg);
    }

    public static ObjectResponse custom(Integer code) {
        return new ObjectResponse(code, "");
    }
